  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "sIayu16uKmAB64ragtN24MbJoVvSr3JoctPbYiascUA",
      // 所在省份
      province: "河北",
      // 所在城市
      city: "保定",
...
//         {"type": "节日", "name": "恋爱纪念日", "year": "2022", "date": "03-17"},
        ...
        {"type": "节日", "name": "小闫", "year": "2003", "date": "04-11"},
        {"type": "生日", "name": "小航", "year": "2003", "date": "05-02"},
    ...
    },
    {
      ...
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {"type": "*生日", "name": "小闫", "year": "2003", "date": "04-11"},
        {"type": "节日", "name": "小航", "year": "2003", "date": "05-02"},
        {"type": "节日", "name": "恋爱纪念日", "year": "2022", "date": "09-20"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
